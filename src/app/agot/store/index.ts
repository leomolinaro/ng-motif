...
export const getFaction = (playerId: string) => createSelector (getPlayerById (playerId), getCardMap, (player, cardMap) => cardMap[player.factionId]);
export const getAgenda = (playerId: string) => createSelector (getPlayerById (playerId), getCardMap, (player, cardMap) => cardMap[player.agendaId]);
export const getRevealedPlot = (playerId: string) => createSelector (getPlayerById (playerId), getCardMap, (player, cardMap) => cardMap[player.revealedPlotId]);
export const getHand = (playerId: string) => createSelector (getPlayerById (playerId), getCardMap, (player, cardMap) => player.handIds.map(handId => cardMap[handId]));
export const getCharacters = (playerId: string) => createSelector (getPlayerById (playerId), getCardMap, (player, cardMap) => player.charactersIds.map(handId => cardMap[handId]));
export const getLocations = (playerId: string) => createSelector (getPlayerById (playerId), getCardMap, (player, cardMap) => player.locationsIds.map(handId => cardMap[handId]));
export const getDiscardPile = (playerId: string) => createSelector (getPlayerById (playerId), getCardMap, (player, cardMap) => player.discardPileIds.map(handId => cardMap[handId]));
export const getPlotDeck = (playerId: string) => createSelector (getPlayerById (playerId), getCardMap, (player, cardMap) => player.plotDeckIds.map(handId => cardMap[handId]));
export const getUsedPlotPile = (playerId: string) => createSelector (getPlayerById (playerId), getCardMap, (player, cardMap) => player.usedPlotPileIds.map(handId => cardMap[handId]));
export const getDeadPile = (playerId: string) => createSelector (getPlayerById (playerId), getCardMap, (player, cardMap) => player.deadPileIds.map(handId => cardMap[handId]));
export const getDrawDeckEmpty = (playerId: string) => createSelector (getPlayerById (playerId), player => player.drawDeckEmpty);
